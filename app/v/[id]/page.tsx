...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://abgsquirtmuncrat.pages.dev/v/${file.filecode}`,
